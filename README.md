...
- [x] Итерация 3 — Управление лидами/оплатами/KPI, алерты, автоотчёты и экспорт работают в единой панели без новых сообщений.
...
- Карточка проекта в админ-панели подгружает метрики, лиды, кампании и оплаты напрямую из `/api/admin/projects/:id` — вкладки обновляются без дополнительных запросов и сразу показывают актуальные настройки KPI/алертов/автоотчётов.
