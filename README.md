# Targetbot — этап 8: автопауза по KPI
...
период автоотчётов настраиваются прямо из Telegram. На этом этапе внедрена конфигурация автопаузы по KPI — можно задать порог
дней и отключать/включать режим из админ-панели.
