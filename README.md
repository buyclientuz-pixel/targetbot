...
- **Выполнено:**
  ...
  - Подготовлена инструкция по подключению Telegram Webhook (`docs/telegram-webhook.md`).
- **Следующее:** Протестировать обновлённый Telegram webhook на staging и обновить runbook по итогам проверки.
