...
- Выполнено: вынесено управление пользователями в бот (добавление, смена ролей, удаление), добавлена интерактивная аналитика с разбивкой по проектам и быстрым экспортом, переработан финансовый раздел с навигацией по оплатам.
- Осталось: реализовать CRM-автоматизации (обновление статусов лидов, напоминания), расширенные сценарии оплаты (счета и автосписания), подключить детальные отчёты/экспорт и настройки расписаний, интегрировать вебхуки Meta.
- Итераций до полного покрытия ТЗ: ≈3 крупные итерации (CRM, финансы автоматизации, отчётность/настройки).
