# Targetbot — этап 12: мастер проекта с биллингом, KPI и алертами

Проект «CI → GitHub → Cloudflare Workers → Telegram-бот отчётов по рекламе Meta» развивается поэтапно. После каркаса,
регистрации чатов, мастера проектов, расписаний, KPI, автопаузы и учёта оплат мастер теперь сразу собирает ключевые настройки:
из создания проекта можно выбрать состояние биллинга, зафиксировать дату оплаты, задать KPI и включить или выключить алерты.
...
- Завершающий шаг мастера позволяет включить или отключить алерты, выбрать пресет окон (`10:00`, `10/14/18`) и управлять
...
- При создании проекта можно сразу выбрать период, расписание, биллинг, KPI и алерты; итоговое сообщение показывает ключевые
  настройки и напоминает о дальнейших шагах.
...
3. Расширить мастер проекта ещё раз: добавить первичную настройку weekly-сводника, автопаузы и статуса автоотчётов.
