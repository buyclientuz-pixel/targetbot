# Targetbot — этап 4: мастер создания проекта
...
3. Расширить мастер проекта: добавить выбор расписания, периодов, KPI и статуса биллинга, а также возможность редактировать
