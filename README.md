...
- [ ] Итерация 3 — Модель данных и хранилища (projects, settings, sessions)
- [ ] Итерация 4 — Meta API и KV-кеш (meta-cache:*, meta-token:*)
...
- **Следующее:** Итерация 3 — описать модель данных (projects/settings/leads/payments/sessions), зафиксировать схемы KV/R2 и подготовить CRUD-helpers.
...
2. Модель данных и CRUD-helpers ⏭️
3. Meta API + кеш
