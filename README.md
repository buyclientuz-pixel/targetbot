...
- [ ] Итерация 1 — Аудит и планирование Cloudflare-рефакторинга
- [ ] Итерация 2 — Базовая инфраструктура Worker (entrypoint, KV/R2 клиенты)
...
- **Выполнено:** Итерация 1 — подготовлен документ `docs/refactor-plan.md` с дорожной картой перехода на новую архитектуру.
- **Следующее:** Итерация 2 — подготовить единый entrypoint Worker и клиенты KV/R2.
