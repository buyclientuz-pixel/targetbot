# Targetbot — этап 10: алерты и zero-spend
...
3. Расширить мастер проекта: добавить выбор расписания, периодов, KPI, статуса биллинга, оплат и настроек alerts сразу при
   создании.
