...
1. Дополнить мастер проектов: добавить выбор чатовых пресетов, проверку прав доступа и повторное подключение к существующим аккаунтам.
...
7. **Настройка пресетов и прав** — добавить выбор чатовых шаблонов, проверку прав доступа и повторное подключение к существующим аккаунтам.
