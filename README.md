...
- Выполнено: реализован мастер создания проекта внутри бота (выбор Meta-аккаунта, группы, подтверждение), синхронизация KV для новых проектов и адаптация inline-кнопок в разделе «Проекты».
- Осталось: автоматизация CRM по лидам (смена статусов, напоминания), расширенные сценарии оплаты и биллинга, детальные отчёты и настройки расписаний, интеграция вебхуков Meta.
- Итераций до полного покрытия ТЗ: ≈2 крупные итерации (CRM/финансы и отчётность/настройки).
