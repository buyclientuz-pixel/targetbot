export const KV_KEYS = {
  ...
  metaLeadForms: (projectId: string, accountId: string) => `meta-lead-forms:${projectId}:${accountId}`,
  projectLeadSyncState: (projectId: string) => `project-lead-sync:${projectId}`,
...
export const KV_PREFIXES = {
  ...
  projectLeadSyncState: "project-lead-sync:",
